...
// PHP service to get auto suggestions

header('Content-Type: application/json');

// Include SpellCorrector program taken from web
include "SpellCorrector.php";

// Setting memory limit to -1 indicating no restrictions
...
if (isset($_REQUEST["query"])) {
  ...
  $responseArray["suggestions"] = $suggestions;
}

$responseArrayJSON = json_encode($responseArray);

echo $responseArrayJSON;
?>
